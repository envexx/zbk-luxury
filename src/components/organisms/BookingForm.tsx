...
const BookingForm: React.FC<BookingFormProps> = ({
  ...
  return (
    <div className={cn('bg-deep-navy text-white', className)}>
      ...
      <div className="flex items-center justify-between px-6 sm:px-8 lg:px-10 py-4 sm:py-5 lg:py-6 border-b border-light-gray">
        <div>
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold">Book Your Ride</h2>
        </div>
        {onClose && (
          <button
            onClick={onClose}
      ...
      {/* Progress Steps - Ukuran lebih kecil dan proporsional */}
      <div className="px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 border-b border-light-gray">
          ...
          {steps.map((step, index) => (
            <div key={step.number} className="flex items-center">
              <div className="flex flex-col items-center">
                <div
                  className={cn(
                    'w-7 h-7 sm:w-8 sm:h-8 lg:w-9 lg:h-9 rounded-full flex items-center justify-center text-[11px] sm:text-xs lg:text-sm font-medium transition-all shadow-sm',
                ...
                <div className="mt-1 sm:mt-1.5 text-center">
                  ...
                  <div className="text-[9px] sm:text-[10px] text-charcoal mt-0.5">
                    {step.description}
                  </div>
                </div>
              </div>
              ...
              {index < steps.length - 1 && (
                <div
                  className={cn(
                    'w-10 sm:w-12 lg:w-16 h-0.5 mx-2 sm:mx-3 transition-all rounded-full',

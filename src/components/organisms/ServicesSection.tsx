...
const services = [
  ...
  },
  {
    ...
    description: 'Professional transportation solutions for corporate events, meetings, and executive travel. Impress your clients with our luxury fleet and professional service.',
  },
  {
    id: 'airport-transfer',
    icon: (
    ...
    description: 'Arrive in style with our dedicated airport transfer service. Professional drivers ensure punctuality and comfort for your journey to and from the airport.',
  },
];
